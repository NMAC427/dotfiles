...
syn keyword	cStatement	goto break return continue asm assert assume
...
if !exists("c_no_c99") " ISO C99
  syn keyword	cType		_Bool bool bit _Complex complex _Imaginary imaginary
...
syn keyword	cTypedef	struct union enum typedef
